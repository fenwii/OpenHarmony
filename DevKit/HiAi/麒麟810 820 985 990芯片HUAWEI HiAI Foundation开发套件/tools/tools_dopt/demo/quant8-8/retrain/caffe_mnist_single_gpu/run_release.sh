...
export  LD_LIBRARY_PATH=/usr/local/nvidia/lib:/usr/local/nvidia/lib64:/usr/local/cuda/lib64:"${ROOT}"/caffe/caffe-mod/libs/
python2 ${ROOT}/caffe/dopt/py2/dopt_so.py  -c  scen.yaml

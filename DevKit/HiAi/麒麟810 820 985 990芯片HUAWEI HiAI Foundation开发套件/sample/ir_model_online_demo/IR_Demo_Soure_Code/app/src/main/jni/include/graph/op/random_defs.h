 ...
 * <Input>
 *    shape : A 1-D tensor. The shape of the output tensor,now only support generate 1-4D tensor,
 *            only support const input or Shape--->RandomStandardNormal
 *    mean  : A 0-D tensor. The mean of the normal distribution.
 *    stddev : A 0-D tensor. The standard deviation of the normal distribution
 * <Output>
 *    y : A Tensor.
 * <Added in HiAI version>
 *    100.320.010.010

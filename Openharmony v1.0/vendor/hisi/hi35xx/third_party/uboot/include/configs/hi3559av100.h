...
/* base on needs #define CONFIG_SYS_INIT_RAM_SIZE  0x1000 */

/* base on needs #define CONFIG_SYS_INIT_SP_ADDR         (CONFIG_SYS_SDRAM_BASE + 0x7fff0) */
...
#ifdef CONFIG_MMC
/* base on needs #define CONFIG_MMC_SDMA */
#define CONFIG_EMMC
...
#if defined(CONFIG_HIFMC) || defined(CONFIG_HIFMC_NAND) || defined(CONFIG_UFS)
#undef CONFIG_EMMC

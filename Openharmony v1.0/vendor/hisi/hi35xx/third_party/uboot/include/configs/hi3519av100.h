...
/* base on needs #define CONFIG_SYS_CACHELINE_SIZE 64 */
...
/* The SMP version for auto update Switch. 1:enable; 0:disable */
#define CONFIG_AUTO_UPDATE          0
#else
/* The AMP version for auto update Switch. 1:enable; 0:disable */

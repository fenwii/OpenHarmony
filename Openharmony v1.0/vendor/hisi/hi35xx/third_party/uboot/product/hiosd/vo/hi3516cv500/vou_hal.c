                                  ...
                                  unsigned long addr)
{
    ...
    t &= ~mask;
    t |= (value << offset) & mask;
    writel(t, (const volatile void *)(hi_uintptr_t)addr);
}
...
hi_s32 sys_hal_vo_hdmi_clk_en(hi_bool hdmi_clk_en)
{
    ...
    hi_reg_set_bit(tmp, 18, IO_ADDRESS(VOU_CRG_PERCTL_ADDR)); /* register 18bit */
...
hi_s32 sys_hal_vo_mipi_clk_en(hi_bool mipi_clk_en)
{
    ...
    hi_reg_set_bit(tmp, 19, IO_ADDRESS(VOU_CRG_PERCTL_ADDR)); /* register 19bit */
...
{
    hi_reg_write32(hd0_div_mod << 12, 0x3 << 12, IO_ADDRESS(VOU_CRG_PERCTL_ADDR)); /* register 12bit to 0x3 */
...
{
    hi_reg_write32(clk_sel << 14, 0x1 << 14, IO_ADDRESS(VOU_CRG_PERCTL_ADDR)); /* register 14bit to 0x1 */
...
hi_s32 sys_hal_vo_hd_out_pctrl(hi_bool clk_reverse)
{
    ...
    hi_reg_set_bit(tmp, 20, IO_ADDRESS(VOU_CRG_PERCTL_ADDR)); /* register 20bit */
...
{
    hi_reg_write32(clk_sel << 21, 0xf << 21, IO_ADDRESS(VOU_CRG_PERCTL_ADDR)); /* register 21bit to 0xf */
...
{
    hi_reg_write32(hdmi_clk_div << 25, 0x1f << 25, IO_ADDRESS(VOU_CRG_PERCTL_ADDR)); /* register 25bit to 0x1f */
...
{
    hi_reg_write32(data_mode << 8, 0x7 << 8, IO_ADDRESS(MISC_CTL18_ADDR)); /* register 8bit to 0x7 */
...
{
    hi_reg_write32(bits_set << 24, 0x7 << 24, IO_ADDRESS(CRG_PERCTL6_ADDR)); /* register 24bit to 0x7 */
...
{
    hi_reg_write32(bits_set << 28, 0x7 << 28, IO_ADDRESS(CRG_PERCTL6_ADDR)); /* register 28bit to 0x7 */
...
{
    hi_reg_write32(bits_set << 12, 0x3f << 12, IO_ADDRESS(CRG_PERCTL7_ADDR)); /* register 12bit to 0x3f */
...
hi_bool hal_disp_set_dither_round_unlim(hal_disp_outputchannel chn, hi_u32 dither_round_unlim)
{
    ...
    switch (chn) {
        case HAL_DISP_CHANNEL_DHD0:
        case HAL_DISP_CHANNEL_DHD1: {
            addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_CTRL.u32));
...
static hi_void hal_disp_set_dither_sed0(hal_disp_outputchannel chn, const hal_disp_dihter_sed *dither_sed)
{
    ...
    if (chn == HAL_DISP_CHANNEL_DHD0) {
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_Y0.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_U0.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_V0.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_W0.u32));
...
static hi_void hal_disp_set_dither_sed1(hal_disp_outputchannel chn, const hal_disp_dihter_sed *dither_sed)
{
    ...
    if (chn == HAL_DISP_CHANNEL_DHD0) {
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_Y1.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_U1.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_V1.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_W1.u32));
...
static hi_void hal_disp_set_dither_sed2(hal_disp_outputchannel chn, const hal_disp_dihter_sed *dither_sed)
{
    ...
    if (chn == HAL_DISP_CHANNEL_DHD0) {
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_Y2.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_U2.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_V2.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_W2.u32));
...
static hi_void hal_disp_set_dither_sed3(hal_disp_outputchannel chn, const hal_disp_dihter_sed *dither_sed)
{
    ...
    if (chn == HAL_DISP_CHANNEL_DHD0) {
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_Y3.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_U3.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_V3.u32));
        ...
        addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_SED_W3.u32));
...
hi_bool hal_disp_set_dither_sed(hal_disp_outputchannel chn, const hal_disp_dihter_sed *dither_sed)
{
...
hi_bool hal_disp_set_dither_thr_min_max(hal_disp_outputchannel chn, hi_u32 thr_min, hi_u32 thr_max)
{
    ...
    switch (chn) {
        case HAL_DISP_CHANNEL_DHD0:
        case HAL_DISP_CHANNEL_DHD1: {
            addr_reg = vo_get_chn_abs_addr(chn, (hi_uintptr_t)&(g_vo_reg->INTF0_DITHER_THR.u32));
...
hi_void hal_layer_csc_set_video_dc_coef(hal_disp_layer layer, vdp_csc_dc_coef *csc_dc_coef)
{
...
hi_void hal_layer_csc_set_gfx_dc_coef(hal_disp_layer layer, vdp_csc_dc_coef *csc_dc_coef)
{
    U_V0_HIPP_CSC_IDC0 V0_HIPP_CSC_IDC0;
    U_V0_HIPP_CSC_IDC1 V0_HIPP_CSC_IDC1;
    U_V0_HIPP_CSC_IDC2 V0_HIPP_CSC_IDC2;
...
hi_void hal_layer_csc_set_video_param(hal_disp_layer layer, const csc_coef_param *coef_param)
{
...
hi_void hal_layer_csc_set_gfx_param(hal_disp_layer layer, const csc_coef_param *coef_param)
{
    U_V0_HIPP_CSC_SCALE V0_HIPP_CSC_SCALE;
    U_V0_HIPP_CSC_MIN_Y V0_HIPP_CSC_MIN_Y;
    U_V0_HIPP_CSC_MIN_C V0_HIPP_CSC_MIN_C;

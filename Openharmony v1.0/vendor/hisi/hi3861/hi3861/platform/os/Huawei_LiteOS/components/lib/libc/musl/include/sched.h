 ...
 *
 * @par Description:
 * The sched_get_priority_max() function shall return the appropriate maximum for the scheduling policy.
 *
 * @attention
 * <ul>
 * <li>LiteOS only support the scheduling policy is SCHED_RR.</li>
 * </ul>
 *
 ...
 * @par Errors
 * <ul>
 * <li><b>EINVAL</b>: The value of the policy parameter does not represent a defined scheduling policy.</li>
 * </ul>
 *
 * @par Dependency:
 * <ul><li>sched.h</li></ul>
 ...
 *
 * @par Description:
 * The sched_get_priority_min() function shall return the appropriate minimum for the scheduling policy.
 *
 * @attention
 * <ul>
 * <li>LiteOS only support the scheduling policy is SCHED_RR.</li>
 ...
 *
 * @par Description:
 * The sched_yield() function force the running thread to relinquish the processor.
 *
 * @attention
 * <ul>
 * <li>None.</li>

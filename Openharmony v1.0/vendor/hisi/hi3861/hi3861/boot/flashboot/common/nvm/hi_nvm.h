...
#define HNV_NCRC_SIZE  8                      /* no crc length */
#define NV_TOTAL_MAX_NUM  255                 /* Maximum number of NVs that can be set */
#define HNV_FAULT_TOLERANT_TIMES  3           /* Error tolerance times */

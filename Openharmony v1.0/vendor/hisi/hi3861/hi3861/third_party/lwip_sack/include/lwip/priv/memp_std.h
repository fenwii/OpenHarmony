...
LWIP_MEMPOOL(L3_EVENT_MSG, MEMP_NUM_L3_EVENT_MSG, sizeof(struct tcpip_msg), "L3_EVENT_MSG")
...
#if LWIP_RPL
LWIP_MEMPOOL(RPL_API_MSG, MEMP_NUM_RPL_API_MSG, sizeof(struct rplapi_msg), "RPL_API_MSG")
#endif
